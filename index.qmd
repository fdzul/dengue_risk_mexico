...
source("heatmap_confirmados.R")
source("heatmap_hospitalizados.R")
source("heatmap_dengue.R")
source("static_bump_map.R")
source("epidemiological_channel.R")
```
...
#path_sinave <- "/Users/fdzul/Library/CloudStorage/Dropbox/dataset/dge/DENGUE2#_.txt"
#x <- data.table::fread(path_sinave,
#                       #select = vect_cols2,
#                       encoding = "Latin-1",
##                      fill=TRUE)
